--[[
    ...
    ULTIMATE ALL-IN-ONE HUB - FULLY FIXED & ENHANCED
    Features: ESP (100% working), Aimbot (target selection), Auto Shoot Murderer (headshot),
    Fling any player, FPS Counter, and all previous features.
]]
...
local function defaults()
    return {
        ...
        -- Aimbot
        aimbotEnabled = false,
        aimbotTarget = "Murderer", -- "Murderer", "Sheriff", "Innocent", "Player" (then use aimbotPlayerName)
        aimbotPlayerName = "",
        aimbotSmooth = 5,
        aimbotFOV = 90,
        aimbotLockOn = false,
        ...
        autoShootTarget = "Murderer", -- "Murderer" only, always headshot
...
local function getPlayerRole(player)
    ...
    -- Check game values (MurderMystery2 folder)
...
-- ============================================================
-- ESP SYSTEM (100% working with BillboardGui + Highlight)
-- ============================================================
local espData = {} -- per player: {highlight, billboard, frame, name, role, health, dist, line}
...
local function createESP(player)
    ...
    roleLbl.Position = UDim2.new(0, 0, 0.45, 0)
...
local function updateESP()
    for player, data in pairs(espData) do
        ...
        if show then
            ...
            -- Name
            data.name.Visible = Yuno.nameEspEnabled
            -- Role
            data.role.Visible = Yuno.roleEspEnabled
...
-- ============================================================
-- AUTO SHOOT MURDERER (Sheriff) - HEADSHOT
-- ============================================================
...
-- ============================================================
-- AUTO KILL (Murderer & Sheriff) - from Script.lua
-- ============================================================
...
ESPTab:Toggle({ Flag = "ESP_Box", Title = "Box ESP", Default = Yuno.boxEspEnabled, Callback = function(v) Yuno.boxEspEnabled = v end })
ESPTab:Toggle({ Flag = "ESP_Name", Title = "Show Names", Default = Yuno.nameEspEnabled, Callback = function(v) Yuno.nameEspEnabled = v end })
ESPTab:Toggle({ Flag = "ESP_Role", Title = "Show Role", Default = Yuno.roleEspEnabled, Callback = function(v) Yuno.roleEspEnabled = v end })
ESPTab:Toggle({ Flag = "ESP_Health", Title = "Show Health", Default = Yuno.healthEspEnabled, Callback = function(v) Yuno.healthEspEnabled = v end })
ESPTab:Toggle({ Flag = "ESP_Distance", Title = "Show Distance", Default = Yuno.distanceEspEnabled, Callback = function(v) Yuno.distanceEspEnabled = v end })
ESPTab:Toggle({ Flag = "ESP_Line", Title = "Line Tracers", Default = Yuno.lineEspEnabled, Callback = function(v) Yuno.lineEspEnabled = v end })
...
print("Yuno Hub loaded with all features enhanced!")